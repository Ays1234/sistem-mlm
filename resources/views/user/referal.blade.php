        ...
        <div class="page-content header-clear-medium">
            ...
            <div class="card card-style">
                <div class="content mt-4 mb-1">
                    <h1 class="text-center font-800 font-40 pt-2 mb-1">Silakan Daftar</h1>
                    ...
                    <form class="md-float-material form-material" action="{{ route('user.daftar') }}" method="POST">
                        ...
                        <div class="input-style no-borders has-icon validate-field mb-4">
                            ...
                            <input type="email" name="email"
                                class="form-control validate-name @error('email') is-invalid @enderror" id="form1a"
                        ...
                        <div class="input-style no-borders has-icon validate-field mb-4">
                            ...
                            <input type="text" name="name"
                                class="form-control validate-name @error('name') is-invalid @enderror" id="form1a"
                        ...
                        @if ($kode_referal->kode_referal == '')
                            <div class="input-style no-borders has-icon validate-field mb-4">
                                <i class="fa fa-lock"></i>
                                <input type="text" name="kode_referal"
                                    class="form-control validate-password @error('kode_referal') is-invalid @enderror"
                                    id="kode_referal" placeholder="Kode Referal"
                                    value="{{ $kode_referal->kode_referal }}">
                                @error('kode_referal')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                @enderror
                                <label for="form3a" class="color-blue-dark font-10 mt-1">Kode Referal</label>
                                <i class="fa fa-times disabled invalid color-red-dark"></i>
                                <i class="fa fa-check disabled valid color-green-dark"></i>
                                <em>(required)</em>
                            </div>

                            <input type="hidden" name="urutan" value="{{ $kode_referal->urut + 1 }}">
                        @else
                        @endif
                        <div class="input-style no-borders has-icon validate-field mb-4">
                            <i class="fa fa-lock"></i>
                            <input type="text" name="kode_transaksi"
                                class="form-control validate-password @error('kode_transaksi') is-invalid @enderror"
                                id="kode_transaksi" placeholder="Kode Transaksi" required=""
                            ...
                            @enderror
                            <label for="form3a" class="color-blue-dark font-10 mt-1">Kode Transaksi</label>
                            <i class="fa fa-times disabled invalid color-red-dark"></i>
                            <i class="fa fa-check disabled valid color-green-dark"></i>
                            <em>(required)</em>
                        </div>
                        ...
                        <div class="input-style no-borders has-icon validate-field mb-4">
                            ...
                            <input type="text" name="phone"
                                class="form-control validate-password @error('phone') is-invalid @enderror" id="phone"
                                placeholder="Nomor telphone" required="" value="{{ old('phone') }}">
                            @error('phone')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            @enderror
                            <label for="form3a" class="color-blue-dark font-10 mt-1">Nomor Phone</label>
                            <i class="fa fa-times disabled invalid color-red-dark"></i>
                            <i class="fa fa-check disabled valid color-green-dark"></i>
                            <em>(required)</em>
                        </div>
                        ...
                        <div class="input-style no-borders has-icon validate-field mb-4">
                            ...
                            <textarea name="alamat" class="form-control validate-password @error('alamat') is-invalid @enderror"
                            ...
                            @enderror
                            <label for="form3a" class="color-blue-dark font-10 mt-1">Alamat</label>
                            <i class="fa fa-times disabled invalid color-red-dark"></i>
                            <i class="fa fa-check disabled valid color-green-dark"></i>
                            <em>(required)</em>
                        </div>
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit"
                                class="btn btn-m rounded-sm mt-4 mb-4 btn-full bg-green-dark text-uppercase font-900">Login</button>
                        </div>
                        ...
                        <div class="d-flex">
                            <div class="w-50 font-11 pb-2 color-theme opacity-60 pb-3 text-start"><a href="/login"
