    ...
    <main class="container-fluid h-100">
        <div class="row h-100 overflow-auto">
            ...
            <div class="col-10 col-md-6 col-lg-5 col-xl-3 mx-auto align-self-center text-center py-4">
                ...
                <h1 class="mb-4 text-color-theme">Silakan Masuk Token Untuk Verifikasi</h1>
                ...
                <form action="{{ route('user.add.verifikasi') }}" method="post"
                    ...
                    <div class="form-group form-floating mb-3 is-valid">
                        <input type="text" name="remember_token"
                            class="form-control  @error('remember_token') is-invalid @enderror" id="form1a"
                            placeholder="Token" value="{{ old('remember_token') }}" autofocus>
                        @error('remember_token')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        @enderror
                        <label class="form-control-label" for="email">Masukan Token</label>
                    </div>
